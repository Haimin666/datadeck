...
from server.storage.redis_manager import sync_redis_client
from datadeck import logger

REDIS_CACHE_KEY = "datadeck:model_cache"
...
class ModelCache:
    ...
    def rebuild(self, providers: list[Any]) -> None:
        from server.services.model_providers.service import resolve_api_key
