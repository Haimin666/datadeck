    ...
    <div class="settings-container">
      ...
      <div class="settings-sider">
        ...
        <div v-if="showStarCard" class="settings-star-card">
          ...
          <p class="star-card-title">给 DataDeck 点个 Star</p>
          ...
          >
            <img
              ...
              src="https://img.shields.io/github/stars/Haimin666/datadeck?label=DataDeck&style=social"
              alt="GitHub stars for DataDeck"
            />
...
const projectRepoUrl = 'https://github.com/Haimin666/datadeck'
